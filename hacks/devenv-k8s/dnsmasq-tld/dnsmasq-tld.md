...
# Local (fake) Top Level Domain (TLD) via dnsmasq

*This script assumes macos.* On windows / WSL2, there are some additional wrinkles to handle which are outside the scope of this document_

Running this script (on a mac) will:
1. install dnsmasq via brew
2. 
